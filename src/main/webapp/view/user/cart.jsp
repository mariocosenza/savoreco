...
<main>
    <c:choose>
        ...
        <c:otherwise>
                                ...
                                <h1>
                                    ...
                                    <svg class="delete" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                         ...
                                         fill="none" onclick="deleteProduct(this, '<c:out
                                            value="${item.food.id}"/>', ${item.food.price * item.quantity}); return false">
                            ...
                            <div>
                                <h2>
                                    ...
                                    <svg class="addIcon" xmlns="http://www.w3.org/2000/svg" width="2em" height="2em"
                                         ...
                                         onclick="addProduct(this, '${item.food.id}', '${item.food.price}'); return false">
            ...
            <h1>Totale costo senza tasse <strong id="price"><fmt:formatNumber value="${requestScope.tot}"
                                                                              pattern="#.##"/></strong>
                <strong>€</strong></h1>
